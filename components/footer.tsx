    ...
    return (
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                EXAMPLE: Uncomment to use social media icons
                    
                */}
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <p className='text-muted-foreground'><a href="mailto:mdrambots@gmail.com"></a>mdrambots@gmail.com</p>

                 
                    <Link
                        href="https://www.instagram.com/mdrambots/"
                        target="_blank"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Rambots, All rights reserved</span>
            </div>
        </footer>
    )
}
